...
<div class="page-wrapper">
    ...
    <section
        style="padding: 80px 0 100px; background: #f4f7f9; min-height: 60vh;"
    >
        <div class="container">
            <div class="success-layout">
                ...
                <div class="success-header">
                    <div
                        class="success-icon {order?.payment_status === 'pending'
                            ? 'bg-warning'
                            : ''}"
                    >
                        <i
                            class="fas {order?.payment_status === 'pending'
                                ? 'fa-hourglass-half'
                                : 'fa-check'}"
                        ></i>
                    </div>
                    ...
                    {#if order?.payment_status === 'pending'}
                        ...
                        {#if order?.payment_reference && order.payment_reference.startsWith('http')}
                            <div
                                style="margin: 20px 0; display:flex; gap:10px; justify-content:center; flex-wrap:wrap;"
                            >
                                <a
                                ...
                                >
                                    Open Payment Page / Change Method in Xendit <i
                            ...
                            <div class="payment-instruction-box">
                                ...
                                {#if order?.payment_expiry}
                                    <span class="expiry-text"
                                        ><i class="fas fa-clock"></i> Pay
                                        before: {order.payment_expiry}</span
                                    >
                                {/if}
                            </div>
                        {/if}
                    {:else}
                        <p>
                            Your transfer has been booked successfully. We'll be
                            in touch shortly.
                        </p>
                    {/if}
                ...
                {#if order}
                    <div class="success-card">
                        <div class="success-card__section">
                            ...
                            <div class="detail-row">
                                <span class="detail-label"
                                    ><i class="fas fa-users"></i> Passengers</span
                                >
                                <span class="detail-value"
                                    >{order.passengers}</span
                                >
                            </div>
                        </div>
                ...
                <div class="whats-next">
                    ...
                    <ul>
                        <li>
                            <i class="fas fa-check"></i> Our team will review and
                            confirm your booking
                        </li>
                        <li>
                            <i class="fas fa-check"></i> A confirmation email
                            will be sent to {order?.email || 'your email'}
                        </li>
                        <li>
                            <i class="fas fa-check"></i> A professional driver will
                            be assigned to your trip
                        </li>
                        <li>
                            <i class="fas fa-check"></i> You'll receive driver details
...
<style>
    ...
    .success-card__total span:first-child {
        font-size: 16px;
        font-weight: 700;
        color: #1e293b;
    }
