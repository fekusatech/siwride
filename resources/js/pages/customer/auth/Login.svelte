                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="contact-page__form-wrapper" style="background: #fff; padding: 40px; border-radius: 10px; box-shadow: 0px 10px 60px 0px rgba(0, 0, 0, 0.05);">
                        <div class="sec-title text-center mb-4">
                            ...
                            <p class="sec-title__text mt-2">Sign in to your account to continue</p>
                        </div>
                        ...
                        <form class="contact-page__form form-one" onsubmit={handleSubmit}>
                            <div class="form-one__group" style="display: block;">
                                <div class="form-one__control form-one__control--full mb-4">
                                ...
                                <div class="form-one__control form-one__control--full mb-4 d-flex justify-content-between align-items-center">
                                    <label class="d-flex align-items-center" style="cursor: pointer;">
                                        <input type="checkbox" bind:checked={form.remember} style="width: auto; height: auto; margin-right: 10px;" />
                        ...
                        <div class="text-center mt-4 pt-3" style="border-top: 1px solid #eee;">
                            <p class="mb-0">Don't have an account? <Link href="/customer/register" style="color: var(--travhub-base); font-weight: 600;">Sign up</Link></p>
                        </div>
                    </div>
                </div>
            </div>
