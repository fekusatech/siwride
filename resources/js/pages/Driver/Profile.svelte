<script lang="ts">
    ...
    const publicProfileUrl = $derived(page.props.public_profile_url as string);
    const initialSlug = $derived(page.props.slug as string | null);
                    ...
                    >
                        ...
                        <div class="mb-3">
                            <label for="slug" class="form-label"
                                >Public Profile URL Slug</label
                            >
                            <div class="input-group">
                                <span class="input-group-text"
                                    >siwride.com/driver/</span
                                >
                                <input
                                    id="slug"
                                    class="form-control"
                                    bind:value={profileForm.slug}
                                    placeholder="your-name"
                                />
                            </div>
                            <small class="text-muted"
                                >This determines your public profile URL. Leave
                                empty to auto-generate from your name.</small
                            >
                            <InputError message={profileForm.errors.slug} />
                        </div>
                        <div class="mb-3">
                            ...
                            <small class="text-muted"
                                >Maximum 2MB. JPG, PNG, or WEBP.</small
                            >
        ...
        <div class="col-xl-4">
            <div class="card border-0 shadow-sm text-center">
                <div class="card-body">
                    {#if previewUrl || user.image}
                        <img
                            src={previewUrl || `/storage/${user.image}`}
                            alt="Profile"
                    ...
                    {:else}
                        <div
                            class="rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center fw-bold mx-auto mb-3"
                    ...
                    <span class="badge bg-success-subtle text-success mt-3"
                        >Driver</span
                    >
                    {#if publicProfileUrl}
