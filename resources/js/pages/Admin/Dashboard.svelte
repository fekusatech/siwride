    ...
    onMount(() => {
        ...
        if (
            ...
            const statusOptions = {
                ...
                labels: charts.status_distribution.labels.map((l) =>
                    l.toUpperCase(),
                ),
            ...
            >
                <div class="flex-grow-1">
                    ...
                    <p class="text-muted mb-0">
                        Overview of your transportation network
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <span
                                class="text-muted text-uppercase fs-12 fw-bold"
                                >Total Bookings</span
                            >
                        ...
                        <div class="align-self-center flex-shrink-0">
                            <div
                                class="avatar-sm bg-primary-subtle rounded-circle"
                            >
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="align-self-center flex-shrink-0">
                            <div
                                class="avatar-sm bg-info-subtle rounded-circle"
                            >
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="align-self-center flex-shrink-0">
                            <div
                                class="avatar-sm bg-danger-subtle rounded-circle"
                            >
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="align-self-center flex-shrink-0">
                            <div
                                class="avatar-sm bg-success-subtle rounded-circle"
                            >
        ...
        <div class="col-xxl-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body text-center">
                    <div
                        id="status-chart"
                        class="apex-charts d-flex justify-content-center"
                    ></div>
                </div>
            </div>
        </div>
                                ...
                                {#each recent_orders as or}
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex flex-column">
                                                <span class="fw-bold"
                                                    >{or.customer_name}</span
                                                >
                                                <small class="text-muted"
                                                    >{or.customer_phone}</small
                                                >
                                            </div>
                                        </td>
                                        <td style="max-width: 200px;">
                                            <div
                                                class="text-truncate"
                                                title={or.pickup_address}
                                            >
                                                <i
                                                    class="ti ti-map-pin text-success me-1"
                                                ></i>
                                                {or.pickup_address}
                                            </div>
                                            <div
                                                class="text-truncate mt-1"
                                                title={or.dropoff_address}
                                            >
                                                <i
                                                    class="ti ti-map-pin text-danger me-1"
                                                ></i>
                                                {or.dropoff_address}
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class={`badge px-2 py-1 ${getStatusBadgeClass(or.status)}`}
                                            >
                                        ...
                                        <td class="text-end pe-4">
                                            <Link
                                                href={`/admin/orders?search=${or.booking_code}`}
