                    ...
                    >
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                />
                                <InputError
                                    message={profileForm.errors.firstname}
                                />
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                />
                                <InputError
                                    message={profileForm.errors.lastname}
                                />
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div
                                    class="avatar-lg d-flex align-items-center justify-content-center flex-shrink-0"
                                ...
                                >
                                    ...
                                    {:else}
                                        <div
                                            class="avatar-title bg-primary-subtle text-primary rounded-circle fs-24 d-flex align-items-center justify-content-center"
                            ...
                            <small class="text-muted"
                                >Max size: 2MB. Format: JPG, PNG, WEBP.</small
                            >
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        <div class="text-end mt-4">
                            <button
                                type="submit"
                                class="btn btn-soft-danger px-4"
        ...
        <div class="col-xl-4">
            <div class="card shadow-sm border-0 text-center">
                <div class="card-body pb-0">
                    <div
                        class="avatar-xl mx-auto mb-3 d-flex align-items-center justify-content-center flex-shrink-0"
                    ...
                    >
                        ...
                        {:else}
                            <div
                                class="avatar-title bg-primary-subtle text-primary rounded-circle fs-40 d-flex align-items-center justify-content-center mx-auto"
                    ...
                    <div
                        class="badge bg-success-subtle text-success px-3 py-2 mb-3"
                    >
                        Administrator
                    </div>
                </div>
                <div
                    class="card-footer bg-light bg-opacity-50 border-0 p-3 mt-3"
                >
