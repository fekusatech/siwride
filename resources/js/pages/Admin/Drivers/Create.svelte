                ...
                <form onsubmit={submit}>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h5 class="mb-3 fs-14 text-uppercase fw-bold">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    bind:value={form.nik}
                                    disabled={form.processing}
                                    placeholder="Enter NIK (National ID)"
                                />
                                {#if form.errors.nik}<div
                                        class="text-danger small mt-1"
                                    >
                                        {form.errors.nik}
                                    </div>{/if}
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                >
                                    <i
                                        class="ti ti-cloud-upload fs-32 text-muted"
                                    ></i>
                                    <h5
                                        class="mt-2 mb-1 fs-13 fw-bold text-primary"
                                    >
                                        Upload NIK Image
                                    </h5>
                                    {#if form.nik_image}
                                        <div
                                            class="mt-1 badge bg-success-subtle text-success border border-success border-opacity-25 px-2 py-1"
                                        >
                                ...
                                {#if driver?.nik_image}
                                    ...
                                    >
                                        <a
                                            href={`/storage/${driver.nik_image}`}
                                            target="_blank"
                                            class="text-primary fs-11 fw-medium text-decoration-underline"
                                        >
                                            <i class="ti ti-photo fs-14"></i> View
                                            Current NIK
                                        </a>
                                    </div>
                                {/if}
                                {#if form.errors.nik_image}<div
                                        class="text-danger small mt-1"
                                    >
                                        {form.errors.nik_image}
                                    </div>{/if}
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    bind:value={form.sim}
                                    disabled={form.processing}
                                    placeholder="Enter SIM (Driver's License)"
                                />
                                {#if form.errors.sim}<div
                                        class="text-danger small mt-1"
                                    >
                                        {form.errors.sim}
                                    </div>{/if}
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                {/if}
                                {#if form.errors.sim_image}<div
                                        class="text-danger small mt-1"
                                    >
                                        {form.errors.sim_image}
                                    </div>{/if}
                            </div>
                        </div>
                        ...
                        {#if !driver}
                            <div class="col-md-12 mt-2">
                                <div
                                    class="card bg-light bg-opacity-10 border-dashed"
                                >
                                    <div class="card-body p-3">
                                        ...
                                        >
                                            <input
                                                ...
                                                id="add_vehicle"
                                                class="form-check-input"
                                                bind:checked={form.add_vehicle}
                                            />
                                            <label
                                                class="form-check-label fw-bold text-uppercase fs-12"
                                                for="add_vehicle"
                                                >Add Vehicle for this Driver
                                                now?</label
                                            >
                                        </div>
                                        ...
                                        {#if form.add_vehicle}
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label
                                                            for="v_registration_number"
                                                            class="form-label text-uppercase fs-11 fw-bold text-muted"
                                                            >Vehicle Plat Number</label
                                                        >
                                                        <input
                                                            type="text"
                                                            id="v_registration_number"
                                                            class="form-control"
                                                            bind:value={
                                                                form.v_registration_number
                                                            }
                                                            placeholder="e.g. B 1234 ABC"
                                                        />
                                                        {#if form.errors.v_registration_number}<div
                                                                class="text-danger small mt-1"
                                                            >
                                                                {form.errors
                                                                    .v_registration_number}
