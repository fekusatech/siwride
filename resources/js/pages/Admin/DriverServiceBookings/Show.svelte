<script lang="ts">
    ...
    function updateStatus(newStatus: string) {
        router.patch(`/admin/driver-service-bookings/${booking.id}/status`, { status: newStatus }, { preserveScroll: true });
    }
...
<AppHead title="Driver Service Booking Detail" />
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><Link href="/admin/driver-service-bookings">Driver Service Bookings</Link></li>
                    <li class="breadcrumb-item active">{booking.booking_code}</li>
                </ol>
            </div>
            <Link href="/admin/driver-service-bookings" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            <small class="text-muted d-block">Name</small>
                            <span>{booking.driver_service?.driver?.name ?? '-'}</span>
                        </div>
                        <div>
                            <small class="text-muted d-block">Email</small>
                            <span>{booking.driver_service?.driver?.email ?? '-'}</span>
                        </div>
                    </div>
                </div>
            </div>
