...
Route::inertia('/drive-with-us', 'Public/DriveWithUs')->name('drive-with-us');
...
Route::post('/activities/{slug}/validate-voucher', [ActivityBookingController::class, 'validateVoucher'])->name('activities.validate-voucher');
